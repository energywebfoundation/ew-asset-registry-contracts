...
export class AssetConsumingDB extends GeneralFunctions {
    ...
    super(
      address
        ...
        : new web3.eth.Contract(
            ...
            AssetConsumingDBJSON.networks.length > 0
  ...
  async getMarketLookupContract(_assetId: number, txParams?: SpecialTx) {
    return await this.web3Contract.methods
      .getMarketLookupContract(_assetId)
      .call(txParams);
  }
